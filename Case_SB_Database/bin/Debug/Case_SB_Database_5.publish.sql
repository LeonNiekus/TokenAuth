/*
Deployment script for Case_SB_DB
...
GO
:setvar DatabaseName "Case_SB_DB"
:setvar DefaultFilePrefix "Case_SB_DB"
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL14.LOCALHOST\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL14.LOCALHOST\MSSQL\DATA\"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6372ff79-772c-4483-bc36-19e05eca2594')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6372ff79-772c-4483-bc36-19e05eca2594')
